...
function usage() {
    ...
    echo "                                 (e.g., quay-proxy.ci.openshift.org/openshift/ci:ocp_release_<tag> or quay-proxy.ci.openshift.org/openshift/ci@sha256:<digest>)."
    ...
    echo "$0 --pull-secret-file ~/pull_secret.json --release-image-url quay-proxy.ci.openshift.org/openshift/ci@sha256:4242c71d4bb159d1be56785216086d0e8573dd3aeb9e7ea30874e985b6fc76d9"
